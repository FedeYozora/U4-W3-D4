...
public class PartitaDiCalcio extends Evento {
    ...
    public PartitaDiCalcio(String titolo, String descrizione, LocalDate dataEvento, TipoEvento tipoEvento, Integer numeroMassimoPartecipanti, Location location, String squadraDiCasa, String squadraOspite, String squadraVincente, int numeroGolSquadraDiCasa, int numeroGolSquadraOspite) {
